...
/** ───────────────────────────────────────────────────────────────────────────
 *  Turbobit — light glass UI
 *  Hero/page glass: #FFFFFF → #F2F2F2
 *  Accent:          #F8641C (primary) | #E35616 (darker)
...
const PLANS = [
  // Premium
  { id: 'tb-prem-1m',  tier: 'Premium', term: '1 Month',  priceUSD: 6.95,  wasUSD: 9.95,  traffic: '600 GB' },
  { id: 'tb-prem-6m',  tier: 'Premium', term: '6 Months', priceUSD: 19.95, wasUSD: 34.95, traffic: '3600 GB' },
  { id: 'tb-prem-1y',  tier: 'Premium', term: '1 Year',   priceUSD: 29.95, wasUSD: 59.95, traffic: '7200 GB' },
  { id: 'tb-prem-2y',  tier: 'Premium', term: '2 Years',  priceUSD: 39.95, wasUSD: 89.95, traffic: '14400 GB' },
  // PLUS (double traffic)
  { id: 'tb-plus-1m',  tier: 'PLUS',    term: '1 Month',  priceUSD: 8.95,  wasUSD: 12.95, traffic: '1200 GB' },
  { id: 'tb-plus-6m',  tier: 'PLUS',    term: '6 Months', priceUSD: 27.95, wasUSD: 44.95, traffic: '7200 GB' },
  { id: 'tb-plus-1y',  tier: 'PLUS',    term: '1 Year',   priceUSD: 39.95, wasUSD: 74.95, traffic: '14400 GB' },
  { id: 'tb-plus-2y',  tier: 'PLUS',    term: '2 Years',  priceUSD: 79.95, wasUSD: 124.95, traffic: '28800 GB' },
] as const;
    ...
    >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 md:py-20">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}} className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Turbobit <span style={{ color: COLORS.primaryDark }}>Premium & PLUS</span> Keys
            </h1>
            <p className="mt-4 text-[color:var(--ink)]/70 text-lg max-w-2xl">
              Choose Premium or PLUS (double traffic), pay with crypto, and get your key instantly after confirmations.
            </p>
            ...
            <div className="mt-4 text-xs text-[color:var(--ink)]/55">
      ...
      <section id="plans" className="py-14 border-t" style={{ borderColor: COLORS.cardEdge }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[color:var(--ink)]/70 mt-2">Premium or Premium PLUS (double traffic) — instant delivery after confirmations.</p>
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {PLANS.map((p) => (
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: selected.id===p.id
                    ? `0 0 0 2px ${COLORS.primary} inset, 0 8px 24px rgba(0,0,0,0.12)`
              ...
              >
                ...
                <div className="mt-2 text-sm text-[color:var(--ink)]/70 inline-flex items-center gap-2">
                  <HardDrive className="h-4 w-4"/>{p.traffic} traffic
                </div>
              </motion.button>
            ))}
          </div>
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-5">
            <TierCard
              title="Premium"
              text="Great value with generous traffic caps and full-speed downloads."
              points={['No ads or wait timers', 'Direct downloads', 'Resume support', 'Download managers supported']}
            />
            <TierCard
              title="Premium PLUS"
              text="Everything in Premium, plus up to 2× traffic allowance."
              points={['Double traffic allowance', 'Same blazing speeds', 'Direct links', 'Parallel downloads']}
            />
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold" style={{ color: COLORS.primaryDark }}>
            💎 Why go Premium on Turbobit.net?
          </h2>

          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <Feature icon={<Zap className="h-5 w-5" />} title="Ultra-fast downloads" text="Up to 10 Gbit/s on all files." />
            <Feature icon={<ShieldCheck className="h-5 w-5" />} title="Secure hosting" text="AES-encrypted transfers." />
            <Feature icon={<PlayCircle className="h-5 w-5" />} title="Resume support" text="Never lose progress on big files." />
            <Feature icon={<Gauge className="h-5 w-5" />} title="No waiting, no ads" text="Direct downloads without captchas." />
            <Feature icon={<Coins className="h-5 w-5" />} title="Massive storage" text="Up to 10 TB included." />
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-[color:var(--ink)]/70">Buy Turbobit Premium / PLUS key direct to Email.</p>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <div className="flex-1 px-4 py-3 rounded-xl bg-white/70 backdrop-blur border text-lg"
                        ...
                        {pLabel(selected)} — ${selected.priceUSD.toFixed(2)} • {selected.traffic} traffic
                      </div>
                      <button
                  ...
                  <div className="w-full flex items-center justify-center">
                    {qrURL() ? (
                      <img
                        ...
                        style={{ borderColor: COLORS.cardEdge, boxShadow: '0 0 35px rgba(248,100,28,0.15)' }}
              ...
              {step !== 'pay' ? (
                <div className="space-y-4">
                  ...
                  <ol className="space-y-3 text-[color:var(--ink)]/80 text-sm">
                    <Step icon={<Bitcoin className="h-4 w-4" />} text="Select a Premium or PLUS plan" />
                ...
                <div>
                  ...
                  <div className="mt-4 grid sm:grid-cols-2 gap-4">
                    <Summary label="Pack" value={pLabel(selected)}/>
                    <Summary label="USD Total" value={`$${selected.priceUSD.toFixed(2)}`} mono/>
                    <Summary label="Traffic" value={`${selected.traffic}`}/>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-5">
                ...
                a={
                  <>
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Choose a <b>Premium</b> or <b>PLUS</b> plan.</li>
              ...
              <QA
                ...
                a={
                  <ul className="list-disc list-inside space-y-1">
                    <li><b>Underpaid:</b> send the difference to the same address before the timer expires.</li>
                    <li><b>Overpaid:</b> contact support with your TX hash—we’ll reconcile.</li>
                    <li><b>Wrong network:</b> For USDT/USDC, network must match. Reach out ASAP if unsure.</li>
                  </ul>
                }
              />
              <QA
              ...
              />
              <QA
                q={<><Mail className="h-4 w-4 opacity-90" /> How to activate my Turbobit key?</>}
                a={
                  <>
                    ...
                    <ol className="mt-2 list-decimal list-inside space-y-1">
                      <li>Log in to your Turbobit account (<a className="underline" href="https://turbobit.net/turbo/v2/" target="_blank" rel="noreferrer">Turbo Access page</a>).</li>
                      <li>Find <b>Apply Premium Key</b>.</li>
                      <li>Paste your key and confirm to activate Premium.</li>
                    </ol>
                  </>
                }
              />
            ...
            <aside className="rounded-2xl border bg-white/70 backdrop-blur p-5" style={{ borderColor: COLORS.cardEdge }}>
              ...
              <ul className="mt-3 space-y-2 text-sm text-[color:var(--ink)]/80">
                <li>✔️ PLUS doubles traffic allowance</li>
...
function TierCard({ title, text, points }:{ title:string; text:string; points:string[] }){
  return (
    <div className="rounded-2xl border bg-white/70 backdrop-blur p-5"
         style={{ borderColor: COLORS.cardEdge }}>
      <div className="inline-flex items-center gap-2" style={{ color: COLORS.primaryDark }}>
        <Flame className="h-4 w-4"/><span className="font-semibold">{title}</span>
      </div>
      <p className="text-[color:var(--ink)]/70 mt-1.5 text-sm">{text}</p>
      <ul className="mt-3 space-y-1 text-sm text-[color:var(--ink)]/80">
