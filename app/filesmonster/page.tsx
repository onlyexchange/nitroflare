...
const PLANS = [
  ...
  { id: 'fm-90',  label: '90 Days',  days: 90,  priceUSD: 37.00 },
  { id: 'fm-180', label: '180 Days', days: 180, priceUSD: 66.00 },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}} className="max-w-3xl">
            ...
            <div className="mt-4 text-xs text-slate-500">
              No KYC • Sender pays network fees • 30-minute payment window • Time left demo: <span className="font-mono text-slate-700">{heroTimeLeft}</span>
            </div>
          </motion.div>
        </div>
      </section>
