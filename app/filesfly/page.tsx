...
/** =======================
 *  FilesFly — Premium Keys
 *  ======================= */

const theme = {
  grad: 'from-sky-500 via-cyan-500 to-blue-600',
  softGrad: 'from-sky-600/20 via-cyan-600/20 to-blue-600/20',
  divider: 'from-sky-500/40 via-cyan-500/30 to-blue-600/40',
...
// FilesFly plans
const PLANS = [
  { id: 'ff-31',  label: '31 Days',  days: 31,  priceUSD: 21.00, wasUSD: 35.00 },
  { id: 'ff-110', label: '110 Days', days: 110, priceUSD: 66.00, wasUSD: 110.00 },
  { id: 'ff-180', label: '180 Days', days: 180, priceUSD: 87.00, wasUSD: 145.00 },
  { id: 'ff-365', label: '365 Days', days: 365, priceUSD: 150.00, wasUSD: 250.00 },
] as const;
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b12] text-white">
      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-black/30 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <a
            ...
            className={`hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r ${theme.grad}`}
          >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}} className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              FilesFly <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400">Premium Keys</span>
            </h1>
            <p className="mt-4 text-white/80 text-lg max-w-2xl">
              Pay with crypto and get your FilesFly premium key <em>instantly</em> to Email.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                ...
                className={`px-5 py-3 rounded-2xl bg-gradient-to-r ${theme.grad} inline-flex items-center gap-2 hover:opacity-95`}
              >
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {PLANS.map((p) => (
              <motion.button
                ...
                className={`text-left rounded-2xl border ${selected.id===p.id? 'border-sky-300/60' : 'border-white/10'} bg-gradient-to-br from-white/10 to-transparent p-5`}
              >
      ...
      {/* Features — FilesFly benefits */}
      <section id="features" className="py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold">💎 FilesFly Premium Benefits</h2>

          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <Feature icon={<Ban className="h-5 w-5" />} title="No interruptions" text="No ads, wait times, or captcha hurdles—just download." />
            <Feature icon={<Zap className="h-5 w-5" />} title="Full-speed downloads" text="Unlimited throttle—use your bandwidth to the max." />
            <Feature icon={<Link2Icon className="h-5 w-5" />} title="Premium-only links" text="Unlock restricted links instantly with Premium." />
            <Feature icon={<Download className="h-5 w-5" />} title="Direct downloads" text="Enable direct-file downloads right from your account." />
            <Feature icon={<HardDrive className="h-5 w-5" />} title="1TB secure storage" text="Plenty of space bundled with your Premium plan." />
            <Feature icon={<Mail className="h-5 w-5" />} title="Instant key delivery" text="We email your Premium key immediately after 2 confirmations." />
          </div>
        </div>
      </section>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-white/70">Buy FilesFly Premium Key — delivered to your email.</p>
              </div>
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl border text-sm
                        ${active ? 'border-sky-300/60 bg-white/10'
                                 : 'border-white/10 hover:border-white/30 bg-white/5'}`}
                    >
                      {chainLabel(c)}
                    </button>
                    ...
                    <button
                      ...
                      className={`w-full px-6 py-4 rounded-2xl inline-flex items-center justify-center gap-2 text-lg
                        ${(!isEmailValid || (methodNeedsLivePrice(method) && !pricesUSD[method]) || (METHOD_NEEDS_CHAIN[method] && !chain) || generating)
                          ...
                          : `bg-gradient-to-r ${theme.grad} shadow-[0_0_25px_rgba(56,189,248,0.35)] hover:opacity-95`}`}
                    >
                  ...
                  <div className="w-full flex items-center justify-center">
                    {qrURL() ? (
                      <img
                        ...
                        width={260}
                        height={260}
                        className="mt-2 rounded-xl border border-white/10 shadow-[0_0_35px_rgba(59,130,246,0.25)]"
                ...
                <div className="space-y-4">
                  ...
                  <ol className="space-y-3 text-white/80 text-sm">
                    <li className="flex items-center gap-3">
                      ...
                      <span>Select a FilesFly Premium plan</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <div className="h-7 w-7 rounded-xl bg-white/5 border border-white/10 grid place-items-center">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <h2 className="text-3xl md:text-4xl font-bold">
              FAQ
              <span className="ml-3 inline-block align-middle h-2 w-24 rounded-full bg-gradient-to-r from-sky-500/70 via-cyan-500/60 to-blue-600/70" />
            </h2>
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl
                           text-sm font-semibold text-white bg-gradient-to-r ${theme.grad}
                           hover:opacity-95 ${theme.glow}`}
              >
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-5">
              <QA
                q={<span className="inline-flex items-center gap-2"><QrCode className="h-4 w-4 opacity-90" />How do I buy a FilesFly key?</span>}
                a={
                  <>
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Pick a plan above & enter your email.</li>
                    ...
                    <p className="mt-2 text-white/70 text-xs">
                      Need a hand? <a href="/support" className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400 underline underline-offset-4 decoration-white/20">Contact support</a>.
                    </p>
                  </>
                }
              />
              ...
              {/* Redeem instructions */}
              <QA
                q={<span className="inline-flex items-center gap-2"><ShieldCheck className="h-4 w-4 opacity-90" />How do I redeem a FilesFly key?</span>}
                a={
                  <>
                    <div className="rounded-xl border border-white/10 bg-gradient-to-br from-sky-600/10 via-cyan-600/10 to-blue-600/10 p-3">
                    ...
                    <ol className="mt-3 list-decimal list-inside space-y-1">
                      <li>Log in to your FilesFly account.{" "}
                        <a
                          href="https://filesfly.cc/"
                          target="_blank" rel="noopener noreferrer"
                          className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400 underline underline-offset-4 decoration-white/20"
                        >
                          Create one here
                        </a>
                        .
                      ...
                      <li>
                        Open your{" "}
                        <a
                          href="https://filesfly.cc/?op=my_account"
                          target="_blank" rel="noopener noreferrer"
                          className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400 underline underline-offset-4 decoration-white/20"
                        >
                          My Account
                      ...
                      <li>Find “Apply Premium Key”, paste your key, and Activate.</li>
                    </ol>
                    <p className="mt-2 text-xs text-white/70">
                      Tip: Keys are case-sensitive—paste without spaces. Make sure you’re logged into the correct FilesFly account.
                    </p>
                  </>
                }
              />
              ...
              <QA
                q={<span className="inline-flex items-center gap-2"><Coins className="h-4 w-4 opacity-90" />Which coins & networks do you support?</span>}
                a={
                  <>
              ...
              <QA
                q={<span className="inline-flex items-center gap-2"><QrCode className="h-4 w-4 opacity-90" />Unique address & price lock?</span>}
                a={
                  <>
                    <div className="text-white/85">Each checkout session gets a fresh address and a 30-minute price lock.</div>
                    <ul className="mt-2 list-disc list-inside space-y-1 text-white/80">
                      <li>Exact-amount payments reduce errors</li>
                      <li>Copy buttons + QR for quick wallet entry</li>
                      <li>Expired? Generate again for a new lock</li>
                    </ul>
                  </>
                }
              />
                ...
                a={
                  <>
                    <ul className="list-disc list-inside space-y-1">
                      ...
                      <li><strong>Overpaid:</strong> <a href="/support" className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400 underline underline-offset-4 decoration-white/20">Contact support</a> with your TX hash—we’ll reconcile.</li>
                      <li><strong>Wrong network:</strong> For USDT/USDC, the network must match. Not sure? <a href="/support" className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400 underline underline-offset-4 decoration-white/20">Reach out</a> ASAP.</li>
                    </ul>
                  </>
                }
              />
              ...
              <QA
                ...
                a={<>During payment, email is temporarily locked. Use “Cancel / Start Over”, update details, then click <em>Buy Now</em> again.</>}
              />

              <QA
                q={<span className="inline-flex items-center gap-2"><ShieldCheck className="h-4 w-4 opacity-90" />Fees & confirmations</span>}
                a="Sender pays network/miner fees. Keys are released after 2 confirmations."
              />
            </div>
            ...
            <aside className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li>✔️ <a href="#features" onClick={(e)=>{e.preventDefault(); scrollToId('features');}} className="underline decoration-white/20 hover:decoration-white">FilesFly benefits</a></li>
                <li>✔️ <a href="/filesfly?plan=ff-110#checkout" className="underline decoration-white/20 hover:decoration-white">110-day pack (deep link)</a></li>
              ...
              <div className="mt-5 rounded-xl border border-white/10 bg-gradient-to-br from-sky-600/10 via-cyan-600/10 to-blue-600/10 p-4">
                ...
                <a
                  ...
                  className={`mt-3 inline-flex items-center gap-2 px-3 py-2 rounded-lg
                             text-sm font-semibold text-white bg-gradient-to-r ${theme.grad} hover:opacity-95`}
                >
                  <Mail className="h-4 w-4" />
                  Contact support
                </a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 text-sm text-white/70">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-2">
              <span className={`inline-flex h-6 w-6 rounded-lg bg-gradient-to-br ${theme.grad}`} />
...
function QA({ q, a }: { q: React.ReactNode; a: React.ReactNode }) {
  return (
    <details className="group rounded-2xl border border-white/10 bg-white/[0.06] backdrop-blur-sm hover:border-white/20 transition overflow-hidden">
      ...
      <div className={`h-px w-full bg-gradient-to-r ${theme.divider}`} />
...
function BG(){
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div className="absolute -top-1/3 left-1/2 -translate-x-1/2 h-[80vh] w-[120vw] rounded-full bg-gradient-to-br from-sky-600/25 via-cyan-600/15 to-blue-600/25 blur-3xl"/>
      <div className="absolute bottom-[-30vh] right-[-10vw] h-[60vh] w-[60vw] rounded-full bg-gradient-to-br from-blue-600/15 via-sky-600/10 to-cyan-600/15 blur-3xl"/>
    </div>
  );
}
