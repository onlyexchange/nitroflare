          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-5">
              ...
              <QA
                ...
                a={
                  <>
                    ...
                    <div className="mt-1 text-white/70 text-sm">We’ll send the key to the email you entered at checkout.</div>
                  </>
                }
              />
              ...
              <QA
                ...
                a={
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li><strong>Wrong network:</strong> For USDT/USDC, the network must match. Not sure? <a href="/support">reach out</a> ASAP.</li>
                  </ul>
                }
              />
              ...
              <QA
                ...
                a={<>During payment, email is locked. Hit <em>Cancel / Start Over</em> to edit, then click <em>Generate</em> again.</>}
              />
            </div>
            ...
            <aside className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm">
                <li>✔️ <a href="#plans" className="underline decoration-white/20 hover:decoration-white">Plan comparison</a></li>
