...
/** ───────────────────────────────────────────────────────────────────────────
 *  TakeFile.link — dark hero, white glass content
 *  Palette:
 *    Primary orange:    #F7921E
 *    Primary dark:      #DE7F10
 *    Hero bg:           #282828
 *    Glass bg:          #FFFFFF → #F6F7FA
...
// Plans
const PLANS = [
  { id: 'tf-30',  label: 'Premium — 30 Days',  days: 30,  priceUSD: 20.99, wasUSD: 34.99, bandwidth: '65 GB / 2 days' },
  { id: 'tf-60',  label: 'Premium — 60 Days',  days: 60,  priceUSD: 38.99, wasUSD: 49.99, bandwidth: '65 GB / 2 days' },
  { id: 'tf-90',  label: 'Premium — 90 Days',  days: 90,  priceUSD: 62.39, wasUSD: 68.99, bandwidth: '65 GB / 2 days' },
  { id: 'tf-365', label: 'Premium — 365 Days', days: 365, priceUSD: 117.99, wasUSD: 129.99, bandwidth: '65 GB / 2 days' },
] as const;
...
export default function Page(){
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-white/60 border-b" style={{ borderColor: COLORS.cardEdge }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-white"
      ...
      {/* Hero (dark) */}
      <section className="relative" style={{ background: COLORS.heroBg }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 md:py-20">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}} className="max-w-3xl text-white">
            <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs mb-6 text-white"
                 style={{ background: `linear-gradient(180deg, ${COLORS.primary} 0%, ${COLORS.primaryDark} 100%)` }}>
              <Zap className="h-3.5 w-3.5 text-white"/> Instant delivery • Live price lock • 30:00 window
              <span className="ml-2 font-mono">{heroTimeLeft}</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              TakeFile.link <span style={{ color: COLORS.primary }}>Premium Keys</span>
            </h1>
            <p className="mt-4 text-white/80 text-lg max-w-2xl">
              Buy with crypto and get your key instantly after confirmations. 65&nbsp;GB every 2 days • no ads • direct downloads.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#checkout"
                onClick={(e)=>{e.preventDefault(); document.getElementById('checkout')?.scrollIntoView({behavior:'smooth'})}}
                className="px-5 py-3 rounded-2xl border inline-flex items-center gap-2 bg-white/10"
      ...
      <section id="plans" className="py-14 border-t" style={{ borderColor: COLORS.cardEdge }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[color:var(--ink)]/70 mt-2">65&nbsp;GB every 2 days • instant key delivery after confirmations.</p>
              ...
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: selected.id===p.id
                    ? `0 0 0 2px ${COLORS.primary} inset, 0 8px 24px rgba(247,146,30,0.18)`
      ...
      <section id="features" className="py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold" style={{ color: COLORS.primaryDark }}>
            💎 TakeFile Premium Benefits
          </h2>

          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <Feature icon={<Gauge className="h-5 w-5" />} title="Unlimited speed" text="No throttling, no slowdowns." />
            <Feature icon={<ShieldCheck className="h-5 w-5" />} title="Direct downloads" text="No ads, no queues, no captchas." />
            <Feature icon={<Zap className="h-5 w-5" />} title="Resume & multi-thread" text="Stable, fast, and reliable." />
            <Feature icon={<Coins className="h-5 w-5" />} title="65 GB / 2 days" text="Plenty of room for your downloads." />
            <Feature icon={<Mail className="h-5 w-5" />} title="Instant email delivery" text="Key sent right after confirmations." />
            <Feature icon={<ShieldCheck className="h-5 w-5" />} title="Secure transfers" text="Encrypted, HTTPS-protected traffic." />
          </div>
        </div>
      </section>
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-[color:var(--ink)]/70">Buy TakeFile.link Premium key and receive it by email.</p>
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: active ? `linear-gradient(180deg, ${COLORS.primary} 0%, ${COLORS.primaryDark} 100%)` : 'rgba(255,255,255,0.7)',
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      <button
                        ...
                        style={{ borderColor: COLORS.cardEdge, background: 'rgba(255,255,255,0.7)' }}
                      >
                        Change
                      </button>
                    </div>
                  ...
                  <div className="w-full flex items-center justify-center">
                    {qrURL() ? (
                      <img
                        ...
                        style={{ borderColor: COLORS.cardEdge, boxShadow: '0 0 35px rgba(247,146,30,0.15)' }}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <a
                href="#plans"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl text-sm border"
                style={{ borderColor: COLORS.cardEdge, background: 'rgba(255,255,255,0.7)' }}
              >
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-5">
                ...
                a={
                  <>
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Choose your <span className="font-semibold">Premium</span> pack.</li>
              ...
              />
              <QA
                q={<><Mail className="h-4 w-4 opacity-90" /> How to activate my TakeFile key?</>}
                a={
                  <>
                    ...
                    <ol className="mt-2 list-decimal list-inside space-y-1">
                      <li>Log in to your TakeFile account (<a className="underline" href="https://takefile.link/user_profile" target="_blank" rel="noreferrer">create one here</a> if needed).</li>
                      <li>Open <span className="font-semibold">Profile / My Account</span>.</li>
                      <li>Paste your key into <span className="font-semibold">Voucher / Premium Key</span> and click <span className="font-semibold">Activate</span>.</li>
                    </ol>
                  </>
                }
              />
            ...
            <aside className="rounded-2xl border bg-white/70 backdrop-blur p-5" style={{ borderColor: COLORS.cardEdge }}>
              ...
              <ul className="mt-3 space-y-2 text-sm text-[color:var(--ink)]/80">
                <li>✔️ 65 GB every 2 days on Premium</li>
