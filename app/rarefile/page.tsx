...
/** ───────────────────────────────────────────────────────────────────────────
 *  RareFile — light glass UI (same structure & UX as NovaFile)
 *  Accent tuned to RareFile blue.
 *  ───────────────────────────────────────────────────────────────────────── */

const COLORS = {
  primary:     '#007DD0',                 // accent
  primaryDark: '#005EA8',                 // darker accent
  check:       '#7CCB5A',
  glassFrom:   '#F3F7FB',
  glassTo:     '#E8F1F8',
  cardEdge:    'rgba(0,125,208,0.14)',
  ink:         '#0A2B3B',
};
...
/* RareFile packs */
const PLANS = [
  { id: 'rf-30',  label: 'Premium — 30 Days',  days: 30,  priceUSD: 7.99,  wasUSD: 12.95 },
  { id: 'rf-90',  label: 'Premium — 90 Days',  days: 90,  priceUSD: 17.99, wasUSD: 32.95 },
  { id: 'rf-180', label: 'Premium — 180 Days', days: 180, priceUSD: 38.99, wasUSD: 53.95 },
  { id: 'rf-365', label: 'Premium — 365 Days', days: 365, priceUSD: 49.99, wasUSD: 89.90 },
] as const;
    ...
    >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 md:py-20">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}} className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              RareFile.net <span style={{ color: COLORS.primaryDark }}>Premium Keys</span>
            </h1>
      ...
      <section id="plans" className="py-14 border-t" style={{ borderColor: COLORS.cardEdge }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[color:var(--ink)]/70 mt-2">Premium plans — instant delivery after confirmations.</p>
              ...
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: selected.id===p.id
                    ? `0 0 0 2px ${COLORS.primary} inset, 0 8px 24px rgba(0,125,208,0.15)`
                    : '0 8px 24px rgba(0,125,208,0.08)',
                }}
              >
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }}>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-[color:var(--ink)]/70">Buy <strong>RareFile.net</strong> Premium key — delivered to your email.</p>
              </div>
            </div>
                  ...
                  <div className="w-full flex items-center justify-center">
                    {qrURL() ? (
                      <img
                        ...
                        style={{ borderColor: COLORS.cardEdge, boxShadow: '0 0 35px rgba(0,125,208,0.15)' }}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-5">
                ...
                a={
                  <>
                    <ol className="list-decimal list-inside space-y-1">
                      <li>Choose a <span className="font-semibold">Premium</span> pack.</li>
              ...
              />
              <QA
                q={<><Mail className="h-4 w-4 opacity-90" /> How to activate my RareFile key?</>}
                a={
                  <>
                    ...
                    <ol className="mt-2 list-decimal list-inside space-y-1">
                      <li>Log in to your RareFile account (<a className="underline" href="http://www.rarefile.net/?op=registration" target="_blank" rel="noreferrer">create one here</a> if needed).</li>
            ...
            <aside className="rounded-2xl border bg-white/70 backdrop-blur p-5" style={{ borderColor: COLORS.cardEdge }}>
              ...
              <ul className="mt-3 space-y-2 text-sm text-[color:var(--ink)]/80">
                ...
                <li>✔️ Deep-link a plan via <code>?plan=rf-365</code></li>
              </ul>
